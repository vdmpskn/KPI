...
public class Mob extends Rectangle {
    ...
    public void draw(Graphics graphics){
            ...
            graphics.drawImage(Screen.tileset_mob[mobID], x, y, width, height, null);

             graphics.setColor(new Color(180,50, 50));
             graphics.fillRect( x,  y - (healthSpace +  healthHeight), width, healthHeight);


             graphics.setColor(new Color(50,180, 50));
             graphics.fillRect( x,  y - (healthSpace +  healthHeight), health, healthHeight);

            graphics.setColor(new Color(0,0,0));
            graphics.drawRect(x,  y - (healthSpace +  healthHeight), health -1, healthHeight - 1);
